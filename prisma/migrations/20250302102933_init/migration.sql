-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STUDENT', 'TEACHER', 'COLLEGE_ADMIN', 'SYSTEM_ADMIN');
...
-- CreateTable
CREATE TABLE "CollegeAdminProfile" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "collegeId" TEXT NOT NULL,
    "isApproved" BOOLEAN NOT NULL DEFAULT false,
    ...
    CONSTRAINT "CollegeAdminProfile_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CollegeAdminProfile_userId_key" ON "CollegeAdminProfile"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "Course_code_collegeId_key" ON "Course"("code", "collegeId");
...
-- AddForeignKey
ALTER TABLE "CollegeAdminProfile" ADD CONSTRAINT "CollegeAdminProfile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CollegeAdminProfile" ADD CONSTRAINT "CollegeAdminProfile_collegeId_fkey" FOREIGN KEY ("collegeId") REFERENCES "College"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
